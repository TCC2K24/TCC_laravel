...
<head>
    ...
    <title>Meu Certificado - Discente</title>
                    ...
                    <h4>Meu Certificado</h4>
                        ...
                        <div class="p-2">
                            <div class="table-responsive">
                                ...
                                <div class="mt-3">
                                    <button class="btn btn-outline-danger me-2" type="submit">Voltar</button>
                                    <button type="submit" class="btn btn-success" type="submit">Baixar</button>
                                </div>
