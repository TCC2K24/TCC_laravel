...
<head>
    ...
    <title>Tela Inicial - Discente</title>
            ...
            <div class="col d-flex align-items-center justify-content-center">
                <div class="w-25 h-50">
                    <div class="text-center">
                        <p class="text-dark"> <mark class="bg-white fw-bold text-primary">Bem-vindo</mark> ao Perfil do
                            Aluno.
                            Este sistema foi desenvolvido para proporcionar uma plataforma intuitiva e eficiente,
                            onde você pode participar das pesquisas de avaliação institucional, responder aos
                            formulários e
                            acessar
                            seus certificados de participação. Sua opinião é fundamental para a melhoria contínua das
                            nossas
                            disciplinas e do corpo docente.
